    ...
    <div className="ad-carousel-container">
      <div className="ad-carousel">
        ...
        <div className="ad-carousel-thumbnails">
          {pictures
            .filter((_, index) => index !== currentPicture)
            .map((picture, index) => (
              <img
                key={index}
                src={picture}
                alt="Ad thumbnail"
                className="ad-carousel-thumbnail"
                onClick={() => setCurrentPicture(pictures.indexOf(picture))}
              />
            ))}
        </div>
          ...
          <div className="ad-carousel-stats hide-on-mobile">
            <div className="ad-carousel-stat">
              <img
                src={m2Icon}
                alt="M2"
                className="ad-carousel-stat-icon"
              />
              <div>
                <span className="ad-carousel-stat-value">100 </span>m2
              </div>
            </div>
            <div>|</div>
            <div className="ad-carousel-stat">
              ...
              />
              <div>
                <span className="ad-carousel-stat-value">3 </span>Locali
              </div>
            </div>
            <div>|</div>
            <div className="ad-carousel-stat">
              ...
              />
              <div>
                <span className="ad-carousel-stat-value">3° </span>Piano
              </div>
            </div>
            <div>|</div>
            <div className="ad-carousel-stat">
              ...
              />
              <div>
                <span className="ad-carousel-stat-value">2 </span>Bagni
              </div>
            </div>
          </div>
          ...
          {/* <div className="ad-carousel-buttons">
            <button>
              <img
                src={yellowLikeIcon}
                alt="Like"
                className="ad-carousel-button-icon"
              />
            </button>
            <button>
              <img
