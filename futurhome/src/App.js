    ...
    <Router>
      <div className="app">
        ...
        <Routes>
          ...
          <Route path="/ads-feed" element={<AdsFeed />} />
        ...
        <Modal isOpen={modalContent !== null} onClose={() => setModalContent(null)}>
          {modalContent === 'login' && <LoginForm openSignup={openSignup} modalContent={modalContent} />}
          {modalContent === 'signup' && <SignupForm openLogin={openLogin} modalContent={modalContent} />}
        </Modal>
